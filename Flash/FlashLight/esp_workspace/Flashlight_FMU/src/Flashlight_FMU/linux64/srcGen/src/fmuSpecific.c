/* @date 2023-06-29T12:59:08.535986743Z */
...
fmi2Integer getFmuInteger(FMUInstance* fmuInstance, const fmi2ValueReference iValueRef) {
	...
	switch(iValueRef) {
		case VRI_Flashlight_fp_counts_data:
			...
			break;
		case VRI_Flashlight_onCount_fp_counts_data:
			iValue = pPrivateCtx->Flashlight_onCount_fp_counts_data;
			break;
...
fmi2Boolean getFmuBoolean(FMUInstance* fmuInstance, const fmi2ValueReference iValueRef) {
	...
	switch(iValueRef) {
		...
		case VRB_Flashlight_button_pin_io:
			...
			break;
		case VRB_Flashlight_onCount_countin_io:
			bValue = pPrivateCtx->Flashlight_onCount_countin_io;
			break;
...
void setFmuInteger(FMUInstance* fmuInstance, const fmi2ValueReference iValueRef, const fmi2Integer iValue) {
	...
	switch(iValueRef) {
		case VRI_Flashlight_fp_counts_data:
			...
			break;
		case VRI_Flashlight_onCount_fp_counts_data:
			pPrivateCtx->Flashlight_onCount_fp_counts_data_isChanged = 1;
			pPrivateCtx->Flashlight_onCount_fp_counts_data = iValue;
			break;
...
void setFmuBoolean(FMUInstance* fmuInstance, const fmi2ValueReference iValueRef, const fmi2Boolean bValue) {
	...
	switch(iValueRef) {
		...
		case VRB_Flashlight_button_pin_io:
			...
			break;
		case VRB_Flashlight_onCount_countin_io:
			pPrivateCtx->Flashlight_onCount_countin_io_isChanged = 1;
			pPrivateCtx->Flashlight_onCount_countin_io = bValue;
			break;
...
void fmuInstanciate(FMUInstance* fmuInstance) {
	...
	pPrivateCtx->Flashlight_onCount_countin_io = 0;
	pPrivateCtx->Flashlight_onCount_countin_io_isChanged = 0;
	pPrivateCtx->Flashlight_onCount_fp_counts_data = 0;
	pPrivateCtx->Flashlight_onCount_fp_counts_data_isChanged = 0;
...
void RTE_ReadHook_Flashlight_onCount_countin_io_Start(Boolean* iValue) {
}

void RTE_ReadHook_Flashlight_onCount_countin_io_Return(Boolean* iValue) {
	sPrivateCtx* pPrivateCtx = (sPrivateCtx*)fmuInst->privateCtx;
	if(pPrivateCtx->Flashlight_onCount_countin_io_isChanged == 1){
		(*iValue) = pPrivateCtx->Flashlight_onCount_countin_io;
		pPrivateCtx->Flashlight_onCount_countin_io_isChanged = 0;
	}
}

void RTE_WriteHook_Flashlight_onCount_fp_counts_data_Start(Integer* iValue) {
}

void RTE_WriteHook_Flashlight_onCount_fp_counts_data_Return(Integer* iValue) {
	sPrivateCtx* pPrivateCtx = (sPrivateCtx*)fmuInst->privateCtx;
	pPrivateCtx->Flashlight_onCount_fp_counts_data = (*iValue);
	pPrivateCtx->Flashlight_fp_counts_data = (*iValue);
}
